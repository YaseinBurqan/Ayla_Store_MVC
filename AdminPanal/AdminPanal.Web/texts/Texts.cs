    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your AdminPanal Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your AdminPanal Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "AdminPanal";
        }
