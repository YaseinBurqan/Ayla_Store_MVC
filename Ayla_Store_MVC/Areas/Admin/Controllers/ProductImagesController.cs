...
namespace Ayla_Store_MVC.Areas.Admin.Controllers
{
    ...
    public class ProductImagesController : Controller
    {
        ...
        public ProductImagesController(AylaStoreMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                Product = p,
                Images = productImages.Where(pi => pi.ProductId == p.Id).ToList()
            });
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AylaStoreMvcContext.ProductImages'  is null.");
            }
            var productImage = await _context.ProductImages.FindAsync(id);
            if (productImage != null)
            {
